...
func (v *Response) GetResponseObject(item *firebasedb.PracticeTestType) *Response {
	temp := &Response{
		Name: item.Name,
		ID:   item.ID,
	}
...
func (v *Response) GetResponseObjectList(item []*firebasedb.PracticeTestType) []*Response {
